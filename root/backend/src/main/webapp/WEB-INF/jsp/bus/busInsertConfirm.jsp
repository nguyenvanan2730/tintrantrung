...
<div id="section" class="container">
	<div id="article" class="card">
		<h3>バス登録確認</h3>
		<p class="question">以下の内容で登録します。よろしいですか？</p>
		...
		<form:form modelAttribute="busForm">
			...
			<input type="submit" value="OK" class="btn btn-primary"formaction="insert" style="margin-right: 20px;">
			<input type="submit" value="戻る" class="btn btn-warning"formaction="input" style="margin-left: 20px;">
		</form:form>
	</div>
</div>
